...
<head>
   ...
   <script type="text/javascript" src="js/buscarLicenciasExpiradas.js"></script>
                                ...
                                <li class="bold active"><a class="collapsible-header waves-effect" tabindex="0"><i class="material-icons">settings</i>Administrar<i class="material-icons right">expand_more</i></a>
                                    <div class="collapsible-body">
                                        <ul class="light">
                                            ...
                                            <li class="active"><a class="waves-effect"><i class="material-icons">departure_board</i>Licencias a vencer</a></li>
            ...
            <!-- <blockquote class="hoverable z-depth-1 contenido grey lighten-5">
                ...
                <div class="row">
                    <div class="col s12 center titulo">
                        <h4 class="modelica-black"><img src="img/titulo.png">&nbsp;LICENCIAS EXPIRADAS</h4>
                    </div>
                </div>
            ...
            <blockquote class="hoverable z-depth-1 contenido white">
                <div class="row">
                    ...
                    <div class="col s12 center sin-historial">
                        <p>Aquellos usuarios del programa vitales, cuyas licencias se encuentren expiradas o próximas a vencer en un rango de 30 días calendario; aparecerán aquí.</p>
                    </div>
                </div>
