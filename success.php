<?php
    // Muestra todos los mensajes correctos
	ob_start();
	session_start();
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Succes | Programa Vitales</title>
    <?php 
    	...
    	<div class="row">
    		<div class="col s12 m9 l6 animate__animated animate__fadeIn animate__dalay-1s">
    			<div class="row z-depth-2">
    				<ul class="tabs tabs-success">
                        <li class="tab col s12">
                            <a class="modelica-bold active">
                                <b>
                                    <i class="material-icons">sentiment_very_satisfied</i>ÉXITO
                                </b>
                            </a>
                        </li>
                    </ul>
