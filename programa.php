      ...
      <li>
         <ul class="collapsible collapsible-accordion">
            <li class="active bold"><a class="collapsible-header waves-effect" tabindex="0"><i class="material-icons">policy</i>Programa Vitales<i class="material-icons right">expand_more</i></a>
              <div class="collapsible-body">
                <ul class="light">
                  <li class="active"><a class="sidenav-close waves-effect">¿Qué es el programa?</a></li>
            ...
            <blockquote class="hoverable z-depth-1 contenido white">
               <div class="row">
                  <div class="col s12 center titulo">
                     <h4 class="modelica-black"><img src="img/titulo.png">&nbsp;¿Qué es el programa?</h4>
                  </div>
               </div>
               <div class="row">
                  <div class="col s12">
                     <article>
                        Es una licencia vial digital entregada por la compañía, donde empezarás a ser CONDUCTOR ORO, la mayor categoría que existe y en la que te retamos a estar con los 12 puntos iniciales, que podrás ir aumentando o disminuyendo anualmente por el buen comportamiento en la vía.
                     </article>
                  </div>
               </div>
